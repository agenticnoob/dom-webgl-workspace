...
## Last Completed Task
ScrollZoomImage gallery effect migration, target `setPosition(...)`, and viewport lifecycle fallback restore.
...
scroll stack to zoom a full-bleed image and moves its WebGL-targeted gallery
