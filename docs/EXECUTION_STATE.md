...
existing runtime capabilities. Text mutation remains a future capability because
the runtime does not yet expose a stable `snapshot/text` mutation target.
...
- Completed work: Added ordered effect declarations, a legacy declaration
  ...
  `effectRegistry` injection, root public registry/plugin exports, and demo
  array-effect declarations.
