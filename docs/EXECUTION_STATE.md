...
Historical Phase 2 scene-gate plan file: `docs/PHASE2_SCENE_GATE_PLAN.md`.
...
- Do not treat scene-gated scroll as the recommended pinned-scroll path.
  Ordinary pinned effects should use the optional React scroll adapter package
  with GSAP ScrollTrigger `pin`/`scrub` and stable `progressKey` data.
